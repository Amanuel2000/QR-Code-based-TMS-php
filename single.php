...
if (isset($_GET['id'])) {
  ...
  $fixture = selectOne('fixtures', ['id' => $_GET['id']]);
  $fixture = selectOne('clubs', ['id' => $_GET['id']]);
   $ads = selectOne('ads', ['id' => $_GET['id']]);
 
  
}
// $informations = selectAll('informations');
$fixtures = selectAll('fixtures');
