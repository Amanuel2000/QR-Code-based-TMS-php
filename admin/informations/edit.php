...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - Add Information</title>
    </head>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Add Information</h2>
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>" >
                    ...
                    <div>
                        <button type="submit"  name="update-info" class="btn btn-big">Update Information</button>
                    </div>
                    </form>
